...
def run_verify():
    ...
    # Rumus: Nilai_Asli = Nilai_Integer / Scale_Factor
    ...
    # Koreksi komponen DC (Index 0) karena scaling faktornya N, bukan N/2
    ...
    # 1. Dikali 2: Karena FPGA membagi sinyal dengan 2 secara total (N vs N/2 gain)
    # 2. Dibagi SCALE: Untuk mengembalikan dari Integer ke Unit Fisik
    ...
    ax1.step(t_axis, input_signal_real, where='mid', color='purple', label='Input Discrete')
    # Plot titik-titik asli untuk memperjelas sampling
    ...
    # Set limit Y agar terlihat rapi sesuai data (tambah margin 10%)
